...
class OptComponents:
    ...
    def start(self, ioloop=None):
        webapp = BokehWebapp(
            ...
            model_factory_fnc=self.build_optresult_model)
        webapp.start(ioloop)
    ...
    def build_optresult_model(self, _=None) -> Tuple[Model, ColumnDataSource]:
        ...
        return model, selector_cds


    def attach_to_page(self, doc: Document) -> Tuple[Model, ColumnDataSource]:
