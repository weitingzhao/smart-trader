    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_data_period', models.CharField(blank=True, max_length=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('category', 'type'), name='utilities_lookup_category_type_pk')],
            },
        ),
        migrations.CreateModel(
