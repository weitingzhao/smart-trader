...
from apps.notifications.tests.tests import AdminTest as BaseAdminTest
from apps.notifications.tests.tests import NotificationTest as BaseNotificationTest
