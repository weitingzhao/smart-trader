...
from home.models.market import MarketSymbol
...
class MarketStockDividend(models.Model):
    ...
    payout_ratio = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    ...
    trailing_annual_dividend_yield = models.DecimalField(max_digits=10, decimal_places=9, null=True, blank=True)
...
class MarketStockPrice(models.Model):
    ...
    regular_market_previous_close = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    regular_market_open = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    regular_market_day_low = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    regular_market_day_high = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
...
class MarketStockValuation(models.Model):
    ...
    beta = models.DecimalField(max_digits=10, decimal_places=5, null=True, blank=True)
    trailing_pe = models.DecimalField(max_digits=10, decimal_places=5, null=True, blank=True)
    forward_pe = models.DecimalField(max_digits=10, decimal_places=5, null=True, blank=True)
    price_to_sales_trailing_12_months = models.DecimalField(max_digits=10, decimal_places=6, null=True, blank=True)
    price_to_book = models.DecimalField(max_digits=10, decimal_places=4, null=True, blank=True)
    book_value = models.DecimalField(max_digits=10, decimal_places=4, null=True, blank=True)
    peg_ratio = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    trailing_peg_ratio = models.DecimalField(max_digits=10, decimal_places=5, null=True, blank=True)
    enterprise_value = models.BigIntegerField(null=True, blank=True)
    enterprise_to_revenue = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    enterprise_to_ebitda = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    trailing_eps = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    forward_eps = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
...
class MarketStockTarget(models.Model):
    ...
    recommendation_mean = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
...
class MarketStockPerformance(models.Model):
    ...
    fifty_day_average = models.DecimalField(max_digits=10, decimal_places=4, null=True, blank=True)
    two_hundred_day_average = models.DecimalField(max_digits=10, decimal_places=5, null=True, blank=True)
    earnings_quarterly_growth = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    earnings_growth = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    revenue_growth = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    gross_margins = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    ebitda_margins = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    operating_margins = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    return_on_assets = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    return_on_equity = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    profit_margins = models.DecimalField(max_digits=10, decimal_places=5, null=True, blank=True)
...
class MarketStockShare(models.Model):
    ...
    shares_percent_shares_out = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    held_percent_insiders = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    held_percent_institutions = models.DecimalField(max_digits=10, decimal_places=8, null=True, blank=True)
    short_ratio = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    short_percent_of_float = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
...
class MarketStockFinancial(models.Model):
    ...
    total_cash_per_share = models.DecimalField(max_digits=10, decimal_places=4, null=True, blank=True)
    ebitda = models.BigIntegerField(null=True, blank=True)
    total_debt = models.BigIntegerField(null=True, blank=True)
    quick_ratio = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    current_ratio = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
